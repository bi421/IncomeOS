...
- [x] Explain why opportunity matches
- [x] Explain missing evidence
...
- [x] Generate application content from verified evidence
...
- [x] Preserve OPENED_IN_BROWSER state
- [x] Preserve PREPARED state
- [x] Human submission remains explicit
- [x] Never claim SUBMITTED without external evidence
- [x] Require external evidence for CONFIRMED
- [x] Test execution contract
